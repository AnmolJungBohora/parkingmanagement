...
<?php
            ...
            if(isset($_POST['addadmin']))
    {
        ...
        $query=mysqli_query($con, "INSERT into admin(firstname,lastname,phonenumber,address,username,email,password,admintype) value('$firstname','$lastname','$phonenumber','$address','$username','$email','$password','$admin_type')");
        if ($query) {
          $_SESSION['success_msg'] = "Admin Details has been added."; 
    ...
    <div class="col">
        ...
        <div class="inputBox">
            ...
            <label class="radio-wrapper radio-label">
                <input type="radio" name="admin_type" value=0 checked>
...
<input type="submit" value="Save" class="submit-btn" name="addadmin">
    ...
    <script>
        function validateForm() {
            var fields = ['firstname', 'phonenumber', 'username', 'password', 'lastname', 'address', 'email'];
            var labels = ['First Name', 'Phone Number', 'Username', 'Password', 'Last Name', 'Address', 'Email'];
            var isValid = true;
            var phoneRegex = /^\d{10}$/; 
